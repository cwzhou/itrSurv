...
extern void F77_NAME(setupinners)(int *t_n, int *t_n_surv, int *t_idvec, int *t_rowvec, int *t_person_ind, int *t_np, double *t_x, double *t_pr, double *t_pr2, double *t_pr2surv, double *t_prsurv, double *t_ord_causeind, double *t_ord_response, int *t_delta, int *t_delta_m, int *t_mTry, int *t_nCat, int *t_sampleSize, int *t_nTree, int *t_nrNodes);
