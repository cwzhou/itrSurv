...
extern void F77_NAME(setupinners)(int *t_n, int *t_np, double *t_x, double *t_pr, int *t_delta, int *t_delta_m, int *t_mTry, int *t_nCat, int *t_sampleSize, int *t_nTree, int *t_nrNodes);
...
static const R_FortranMethodDef FortranEntries[] = {
    ...
    {"setupinners",     (DL_FUNC) &F77_NAME(setupinners),     11},
