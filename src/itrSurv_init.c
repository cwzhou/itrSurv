...
extern void F77_NAME(setupbasics)(int *t_nt,int *t_nt_death, double *t_dt, double *t_rs, int *t_ERT, int *t_uniformSplit, int *t_nodeSize, int *t_minEvent, int *t_rule, int *t_sIndex, double *t_sFraction, double *t_stratifiedSplit, int *t_replace);
extern void F77_NAME(setupinners)(int *t_n, int *t_idvec, int *t_np, double *t_x, double *t_pr, double *t_pr2, double *t_pr2surv, double *t_prsurv, double *t_ord_causeind, double *t_ord_response, int *t_delta, int *t_delta_m, int *t_mTry, int *t_nCat, int *t_sampleSize, int *t_nTree, int *t_nrNodes);
...
static const R_FortranMethodDef FortranEntries[] = {
    ...
    {"setupbasics",     (DL_FUNC) &F77_NAME(setupbasics),     13},
    {"setupinners",     (DL_FUNC) &F77_NAME(setupinners),     17},
